          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Update WA</h3>
              ...
              <div class="card-body">
                <div class="col-md-12">
                    <form class="form-horizontal" action="{{route('update-master-wa')}}" method="POST" enctype="multipart/form-data" id="myForm">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                              <input type="text" class="form-control" id="ip" name="ip" value="{{$data->ip}}" placeholder="ip">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="name" class="col-sm-2 control-label">port</label>
                            <div class="col-sm-12">
                              <input type="text" class="form-control" id="port" name="port" value="{{$data->port}}" placeholder="port">
                            </div>
                        </div>
                        <div class="form-group">
